...
DROP TABLE IF EXISTS sepsis.ventsettings CASCADE;
CREATE TABLE sepsis.ventsettings AS
select
...
--DROP MATERIALIZED VIEW IF EXISTS sepsis.VENTDURATIONS CASCADE;
DROP TABLE IF EXISTS sepsis.VENTDURATIONS CASCADE;
create table sepsis.ventdurations as
...
DROP TABLE sepsis.ventsettings;
