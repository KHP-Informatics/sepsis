...
select labevents.subject_id, 
		...
		from labevents left join icustays 
				...
				and labevents.charttime between icustays.intime and icustays.intime + interval '28' hour
...
select 	inputevents_cv.subject_id, 
		...
		from inputevents_cv left join icustays 
				...
				and inputevents_cv.charttime between icustays.intime and icustays.intime + interval '28' hour
...
select 	inputevents_mv.subject_id, 
		...
		from inputevents_mv left join icustays 
				...
				and inputevents_mv.starttime between icustays.intime and icustays.intime + interval '28' hour
union 
...
select 	chartevents.subject_id, 
		...
		from chartevents left join icustays 
				...
				where chartevents.itemid in(select distinct itemid from sepsis.all_items)
						and chartevents.charttime between icustays.intime and icustays.intime + interval '28' hour
...
select 	procedureevents_mv.subject_id, 
		...
		from procedureevents_mv left join icustays 
				...
				and procedureevents_mv.starttime between icustays.intime and icustays.intime + interval '28' hour ;
