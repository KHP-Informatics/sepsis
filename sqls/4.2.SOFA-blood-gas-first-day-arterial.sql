...
DROP MATERIALIZED VIEW IF EXISTS sepsis.bloodgasfirstdayarterial CASCADE;
CREATE MATERIALIZED VIEW sepsis.bloodgasfirstdayarterial AS
with stg_spo2 as
(
...
select bg.*
  ...
  , s1.spo2
from sepsis.bloodgasfirstday bg
